...
icd_subquery_1_path = '/gpfs/data/mankowskilab/NYU_Consult_raw/ICD10_subquery_1.csv'
icd_subquery_2_path = '/gpfs/data/mankowskilab/NYU_Consult_raw/ICD10_subquery_2.csv'
nyuqa_demo_path = '/gpfs/data/mankowskilab/NYU_Consult_raw/nyu_qa_pt_demographic.sql.csv'
diag_data_path = '/gpfs/data/mankowskilab/NYU_Consult_raw/nyuqa_diagnosis.csv'
scraped_icds_path = "/gpfs/data/mankowskilab/NYU_Consult_raw/2020_2024_icds_all_revised.json"
yifan_demo_path = "/gpfs/data/oermannlab/users/xh852/yifan_dx_med_icd10_post_join.csv"
