...
conversation_path = #Add your path here
if __name__ == "__main__":
    ...
    with ProcessPoolExecutor(max_workers=64) as executor:
        ...
        for chunk in chunk_tasks(tasks, chunk_size):
            future_to_patient = {executor.submit(process_pat_data_better, patient_id, patient_data): patient_id for patient_id, patient_data in chunk}
    ...
    crude_word_df.to_json('refined_pat_msgs_new_algo.json')
